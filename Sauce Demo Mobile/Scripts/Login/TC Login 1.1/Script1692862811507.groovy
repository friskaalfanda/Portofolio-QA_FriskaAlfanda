...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText (2)'), '10203040', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Login'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/android.widget.TextView - Products'), 0)
