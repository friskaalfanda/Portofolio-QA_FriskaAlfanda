...
WebUI.setText(findTestObject('Checkout/input_Checkout Your Information_postalCode'), '')
...
WebUI.verifyElementText(findTestObject('Checkout/error_lastname'), 'Last Name Required')
