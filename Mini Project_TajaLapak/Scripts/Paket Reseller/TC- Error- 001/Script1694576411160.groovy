...
WebUI.uploadFile(findTestObject('Paket Reseller/input_Icon Image_paket'), 'C:\\Users\\frisk\\OneDrive\\Pictures\\document.docx')
...
icon_image = icon_image.replace('.docx', '')
...
WebUI.verifyElementText(findTestObject('Paket Reseller/input_Icon Image_paket'), 'Enter a valid data format.')
