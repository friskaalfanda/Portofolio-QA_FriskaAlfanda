...
WebUI.callTestCase(findTestCase('Tracking Order/TC- Checkout Order'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Tracking Order/input_No Invoice'), '')
...
field_noInvoice = webDriver.findElement(By.xpath("(//input[@name='a'])[3]"))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_noInvoice)
