...
WebUI.setText(findTestObject('Tracking Order/input_No Invoice'), 'TRX97.20230914171940')
...
WebUI.verifyElementText(findTestObject('Tracking Order/input_Alamat E-mail_Tracking Orders'), 'Please fill out this field.')
