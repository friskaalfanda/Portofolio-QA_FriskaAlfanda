...
WebUI.click(findTestObject('Tracking Order/input_transferBank'))

WebUI.click(findTestObject('Tracking Order/button_Proses Pembayaran'))

no_Invoice_TransferBank = WebUI.getText(findTestObject('Tracking Order/no_Invoice_TransferBank'))
...
WebUI.setText(findTestObject('Tracking Order/input_No Invoice'), no_Invoice_TransferBank)
