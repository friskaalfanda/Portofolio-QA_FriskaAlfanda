...
WebUI.setText(findTestObject('Jemput Zakat Online/Input_Alamat Email'), 'friska@g.com')
...
WebUI.verifyElementText(findTestObject('Jemput Zakat Online/Verifikasi_BerhasilZakat'), 'Inputan tidak valid, masukkan email yang valid')
