...
WebUI.verifyElementPresent(findTestObject('Jemput Zakat Online/Verifikasi_Jemput Zakat Online_Page'), 10)

WebUI.selectOptionByValue(findTestObject('Jemput Zakat Online/Dropbox_JenisZakat'), 'Zakat Fitrah', false)

WebUI.setText(findTestObject('Jemput Zakat Online/Input_Ongkir'), GlobalVariable.Nama_User)

WebUI.setText(findTestObject('Jemput Zakat Online/Input_No Handphone'), '081234656125365')
...
WebUI.setText(findTestObject('Jemput Zakat Online/input_OngkirRp'), '65')

WebUI.click(findTestObject('Jemput Zakat Online/button_Jemput Zakat Sekarang'))

WebUI.verifyElementText(findTestObject('Jemput Zakat Online/Verifikasi_BerhasilZakat'), 'Inputan tidak valid, masukkan No Telpon yang valid')
