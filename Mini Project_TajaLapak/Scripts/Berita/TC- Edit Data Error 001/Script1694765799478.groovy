...
WebUI.click(findTestObject('Berita/button_edit berita'))

WebUI.verifyElementPresent(findTestObject('Berita/verifikasi_edit berita page'), 10)

WebUI.setText(findTestObject('Berita/input_Judul Berita'), '')
...
field_judul_berita = webDriver.findElement(By.xpath('//input[@name=\'b\']'))

//Mengambil Error Messge
error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', field_judul_berita)
